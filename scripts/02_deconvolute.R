...
# Load snRNAseq
# Markers and annotated cell types are output from another project
# Check github.com/guralbrian/bulk_decon for info. add_jensen_fastq branch from 3/27/24
...
colnames(decon.melt) = c('id', 'CellType', 'Prop')
